...
int main ()
{
  ...
  cout<<"Wprowadzenie\n";
  typ1 a; a.PrzedstawSie(); // Nazywam sie 1 (adres obiektu: <adres_obiektu>)
  typ2 b; b.PrzedstawSie(); // Nazywam sie 2 (adres obiektu: <adres_obiektu>)
  typ3 c; c.PrzedstawSie(); // Nazywam sie 3 (adres obiektu: <adres_obiektu>)
  typ4 d; d.PrzedstawSie(); // Nazywam sie 4 (adres obiektu: <adres_obiektu>)
